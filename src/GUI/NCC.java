...
public class NCC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lb_welcome.setText("NHÀ CUNG CẤP");
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        ...
        try{
            if (txt_mancc.getText().trim().equals("")||
                ...
                mh.setMaNCC((txt_mancc.getText()));
                mh.setTenNCC(txt_tenncc.getText());
                mh.setSDT((txt_sdt.getText()));
                mh.setDiachi(txt_diachi.getText());
                JOptionPane.showMessageDialog(this, nccBUS.addNCC(mh));
                loadNCCList();
            }
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        try{
            if (txt_mancc.getText().trim().equals("")||
                ...
                mh.setSDT(txt_sdt.getText());
                mh.setDiachi(txt_diachi.getText());
                JOptionPane.showMessageDialog(this, nccBUS.chinhsuaNCC(mh));
                loadNCCList();
            }
        } catch (NumberFormatException ex){
            JOptionPane.showMessageDialog(this, "Thong tin khong hop le");
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        ...
        if (index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn 1 Nhà cung cấp trong bảng để xóa", "Thông Báo", 1);
            return;
        }
        DTO_NCC mh = new DTO_NCC();
        mh.setMaNCC(txt_mancc.getText());
      ...
      if (tk==JOptionPane.YES_OPTION)  
      {
          ...
          mh.setTrangThai(0);
          JOptionPane.showMessageDialog(this, nccBUS.xoaNCC(mh));
          loadNCCList();
      }
      else
      {
